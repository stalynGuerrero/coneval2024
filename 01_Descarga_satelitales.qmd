...
```{r, echo=FALSE}
statelevel_predictors_df <- readRDS("../input/2020/predictores/statelevel_predictors_satelite.rds")
tba(statelevel_predictors_df %>% head(10), cap = "Variables satelitales descargadas")
```
